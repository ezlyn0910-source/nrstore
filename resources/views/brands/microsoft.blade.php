...
<div class="bid-page">
    ...
    <section class="brand-hero-section">
        ...
        <div class="brand-hero-overlay">
            ...
            <p class="brand-hero-subtitle">Discover amazing Microsoft products through competitive bidding</p>
                    ...
                    <div class="brand-products-grid">
                        ...
                        <div class="brand-product-card">
                            <div class="product-image">
                                <img src="{{ asset('storage/products/microsoft2.png') }}" alt="Surface Pro 9">
                            </div>
                            <div class="product-info">
                                ...
                                <div class="countdown-timer">
                                    ...
                                    <div class="countdown-display" data-end-date="2026-05-15T23:59:59">
                        ...
                        <div class="brand-product-card">
                            <div class="product-image">
                                <img src="{{ asset('storage/products/microsoft1.png') }}" alt="Xbox Series X">
                            </div>
                            <div class="product-info">
                                ...
                                <div class="countdown-timer">
                                    <div class="countdown-label">Auction Ends In:</div>
                                    <div class="countdown-display" data-end-date="2026-04-31T23:59:59">
                                        <div class="countdown-unit">
                                            <div class="countdown-box">
                                                <span class="countdown-value" data-months>2</span>
                                            </div>
